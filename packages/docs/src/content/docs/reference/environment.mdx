...
<Aside type="tip">
  Get a free HuggingFace token at [huggingface.co/settings/tokens](https://huggingface.co/settings/tokens). The free tier provides access to thousands of open-source models including Llama, Mistral, Qwen, and DeepSeek via `huggingface:` or `hf:` prefix.
</Aside>
