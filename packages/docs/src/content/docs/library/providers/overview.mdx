...
<CardGrid>
  ...
  <LinkCard
    ...
    href="/library/providers/openrouter/"
  />
</CardGrid>
...
| `flash-lite` | `gemini:gemini-2.5-flash-lite` | Gemini |
...
- [OpenRouter Provider](/library/providers/openrouter/) - 400+ models via unified gateway
