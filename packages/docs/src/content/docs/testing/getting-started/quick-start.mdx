...
describe('Error Handling', () => {
  it('should handle LLM errors gracefully', async () => {
    mockLLM()
      .forAnyModel()
      .withResponse(() => { throw new Error('Rate limit exceeded'); })
      .register();
...
- [MockBuilder API](/testing/mocking/overview/) - Advanced mocking patterns
- [Testing Gadgets](/testing/gadgets/test-gadget/) - In-depth gadget testing
- [Testing Agents](/testing/mocking/overview/#multi-turn-conversations) - Complex agent scenarios
