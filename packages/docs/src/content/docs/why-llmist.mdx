...
<CardGrid>
  ...
  <Card title="Multi-Provider Support" icon="random">
    First-class support for **OpenAI, Anthropic, Gemini, and HuggingFace**. Auto-discovery from environment variables. Model shortcuts like `sonnet`, `gpt4o`, `flash`.
  </Card>
...
<CardGrid stagger>
  ...
  <Card title="Multi-Provider Applications" icon="random">
    If you want to switch between OpenAI, Anthropic, Gemini, and HuggingFace without code changes.
  </Card>
